      ...
      <div className="container-fluid">
        ...
        <Collapse defaultActiveKey={['1']} size="large" >
          ...
          <Panel header="IV. Năng lượng" key="4" className='Panel'>
            ...
            <br/>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
            Đơn vị dùng để đo lượng năng lượng là <i>jun</i> hoặc <i>calo</i>. Hầu hết mọi người quen thuộc hơn với thuật ngữ calo. Đây không phải là vấn đề vì mối quan hệ đơn giản giữa hai đơn vị là một calo bằng 4,18 jun. Tỷ lệ này rất hữu ích trong việc thiết lập các vấn đề yêu cầu chuyển đổi đơn vị này sang đơn vị khác.
            </p>
          </Panel>
          <Panel header="V. Các loại năng lượng" key="5" className='Panel'>
            <p>Năng lượng được tìm thấy dưới nhiều hình thức. Như đã đề cập ở trên, năng lượng có thể tồn tại dưới dạng nhiệt hoặc điện. Các dạng năng lượng khác là âm thanh, ánh sáng, năng lượng hóa học và năng lượng hạt nhân. Có lẽ hai dạng năng lượng quan trọng nhất trong hóa học là <i>thế năng</i> và <i>động năng</i>. Năng lượng tiềm năng là năng lượng được lưu trữ. Một ví dụ điển hình là một người giơ búa lên, sẵn sàng đóng đinh.
            <br/>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
